...
const EnachConvertForm = (props) => {
  ...
  const requestMap = {
    ...
    checksum: { currentDate } + "|2023-08-08|||5000.00",
    checksumeEncrypted:
  ...
  return (
    ...
    >
      ...
      <input
        ...
        value="e57b2fe73169ba8a4cb103c70be2a4e179a17cffd74031d024fc6224f7f8826b"
      />
      <input
        type="hidden"
        ...
        value="L001"
      />
      <input type="hidden" id="MsgId" name="MsgId" value="L1000229" />
      <input
        type="hidden"
        id="Customer_Name"
        name="Customer_Name"
